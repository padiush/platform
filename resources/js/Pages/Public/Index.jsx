        ...
        <PublicLayout title="Padiush">
            ...
            <div className="p-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
                    <FeatureCard image={images.collab} title={t('public.feature_collab_title')}>
                        {t('public.feature_collab_desc')}
                    </FeatureCard>
                    <FeatureCard image={images.custom} title={t('public.feature_custom_title')}>
                        {t('public.feature_custom_desc')}
                    </FeatureCard>
                    <FeatureCard image={images.catalog} title={t('public.feature_catalog_title')}>
                        {t('public.feature_catalog_desc')}
                    </FeatureCard>
                    <FeatureCard image={images.usage} title={t('public.feature_usage_title')}>
                        {t('public.feature_usage_desc')}
                    </FeatureCard>
                    <FeatureCard image={images.data} title={t('public.feature_data_title')}>
                        {t('public.feature_data_desc')}
                    </FeatureCard>
                    <FeatureCard image={images.community} title={t('public.feature_community_title')}>
